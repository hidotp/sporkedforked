    ...
    <Transition.Root show={isOpen} as={Fragment}>
      ...
      >
        <div className="flex min-h-full items-center justify-center py-10 px-4 text-center sm:p-0">
          ...
          >
            <div className="modal inline-block transform overflow-hidden rounded-lg px-4 pt-5 pb-4 text-left align-bottom shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-sm sm:p-6 sm:align-middle">
              <button
                onClick={() => handleClose()}
                tabIndex={0}
                aria-pressed="false"
